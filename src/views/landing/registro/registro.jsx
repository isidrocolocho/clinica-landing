...
export default function Registro() {
    ...
    const handleTipoRegistroChange = (e) => {
        ...
        setFormValues({ ...formValues, numero_junta: '' }); // Reset número de junta si cambia a 3
    };
    ...
    const validateForm = () => {
        ...
        if (tipoRegistro === "2" && !formValues.numero_junta.trim()) newErrors.numero_junta = "El número de junta es obligatorio.";
        return newErrors;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const dataToSend = {
            ...
            numero_junta: tipoRegistro === "2" ? formValues.numero_junta : null,
        };
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center bg-white pt-38">
                <div className="w-full max-w-md px-8">
                    <form onSubmit={handleSubmit}>
                        ...
                        {tipoRegistro === "2" && (
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="numero_junta">
                                    Número de junta
                                </label>
                                <input
                                    className="w-full border-b-2 border-blue-600 focus:outline-none focus:border-blue-800"
                                    ...
                                    type="text"
                                    name="numero_junta"
                                    value={formValues.numero_junta}
                                    onChange={handleChange}
                                    placeholder="Ingrese su número de junta"
                                />
                                {errors.numero_junta && <p className="text-red-500 text-xs mt-1">{errors.numero_junta}</p>}
                            </div>
                        )}
                        <button
                            type="submit"
